...
Filter buttons at the top: **Active** (default — hides cancelled), **All**, **Scheduled**, **Confirmed**, **Completed**, **Cancelled**.

The app defaults to "Active" so cancelled sessions don't clutter the view. Tap "All" or "Cancelled" to see them.
