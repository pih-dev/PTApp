...
| `2026-08-20-app-name-brainstorm.md` | Round 2 — PT prefix dropped. Why the category's `Fit*/Coach*` names all blur, why the top global apps describe nothing, the verb test, and the Arabic-rooted candidates (**Daftar** recommended). Also records that Elie never proposed a name in any session |
