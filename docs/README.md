...
- [Suite 2 — the acoustic engine](2026-08-24-suite2-acoustic-engine.md) `docs/2026-08-24-suite2-acoustic-engine.md` — why the v2.31 suite sounded synthesized (additive oscillators have no noise, inharmonicity, body or room) and the engine that fixes it: breath-noise flute, Karplus-Strong guitar, inharmonic beating piano, formant sax, 8-line FDN room. Seven pieces of 52–58 s. **One arrangement folds down to 7.1/5.1/stereo — the two-scripts-by-hand trap is gone.** 🔴 **Dolby caps at 5.1 in ffmpeg and Atmos needs the licensed encoder** — the 7.1 file is real 8-channel AAC with no Dolby badge
