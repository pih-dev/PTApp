...
const readmeLines = [
  ...
  '',
  'STATUS: CONFIRMED BY ELIE 2026-07-14 (in-session). The 18-39 rows are the levels he',
  'approved; the older age bands are those levels scaled down by the decline factors from',
  'his age-range tables (each band’s benchmark ÷ the 18-39 benchmark, per lift, per gender).',
  '',
