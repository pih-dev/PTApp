...
- **v2.37–v2.42** (08-23) — Big Steps type, Display sheet, Judging Bench; swipe-week (NO setPointerCapture: tappable children); `--trench` + `sanity-contrast` (a screenshot finding is audited in EVERY skin); `--on-bar` + radius tokens; 21 skins = 7 families × light/optimal/dark, flanks GENERATED by `gen-skin-variants.mjs`; pebble→FLINT. → `v2.37`…`v2.42`
