...
## Version History
- **v2.43–v2.45** (08-23/24) — the login went live (email + guest + token) + the Spot mark; two anatomy passes over the figures; vc25 (v2.45) to Play Alpha. → `v2.43`…`v2.45`
...
- **v2.17–v2.36** (08-21/23) — the design pass, the movement library, the figures; logo, opening + sound, turns, the Library tab; NEEDLE; the legibility pass. → `v2.17`…`v2.36`
