...
| program, programme, exercise bank, volume, weak point, generation rules, reps, sets, rep range, load, progressive, progression, overload, hypertrophy, strength, strenght, pyramid, descending, deadlift, squat, bench, anchor, anchors, training day, rest day | `docs/superpowers/specs/2026-07-13-program-generation-design.md`, `docs/instructions-v2.13.md` |
| 1RM, one rep max, norms, standards, evaluate, evaluation, age category, declination, percentage per age, classification, grading | `docs/superpowers/specs/2026-07-06-1rm-battery-replaces-mass-design.md`, `docs/instructions-v2.12.md` |
